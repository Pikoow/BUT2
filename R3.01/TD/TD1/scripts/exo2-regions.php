   ...
   <table>
      ...
      <?php
         ...
         function trouve_region($code) {
            ...
            foreach ($regions as $nomRegion => $dept) {
               if (in_array($code, $dept)) {
                  return $nomRegion;
               }
            }
         }

         foreach ($depts as $numDept => $values) {
      ?>
      <tr>
         <td>
            <?php
               echo htmlentities($numDept);
            ?>
         </td>
         <td>
            <?php
               echo htmlentities($values[0]) . " (" . trouve_region($numDept) . ")";
            ?>
         </td>
         <td>
            <?php
               echo htmlentities($values[1]); }
            ?>
         </td>
      </tr>
   </table>
